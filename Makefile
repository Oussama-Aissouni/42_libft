...
C_FILES = ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c\
		...
		ft_tolower.c ft_toupper.c ft_strtrim.c ft_strjoin.c ft_split.c\
		ft_itoa.c ft_strmapi.c ft_striteri.c ft_putchar_fd.c ft_putstr_fd.c\
		ft_putendl_fd.c ft_putnbr_fd.c\

O_FILES = ft_atoi.o ft_bzero.o ft_calloc.o ft_isalnum.o\
		...
		ft_strlen.o ft_strncmp.o ft_strnstr.o ft_strrchr.o ft_substr.o\
		ft_tolower.o ft_toupper.o ft_strtrim.o ft_strjoin.o ft_split.o\
